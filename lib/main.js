    ...
    rotateLoop(i){ 
        ...
        switch (panel.id) {
            case 'upper-left':
                    ...
                    setTimeout(function() {  panel.classList.add('slide-upper-left');}, (fortuneTeller.colorLength * 1000));
            ...
            case 'upper-right':
                    ...
                    setTimeout(function() {  panel.classList.add('slide-upper-right');}, (fortuneTeller.colorLength * 1000));
            ...
            case 'lower-left':
                    ...
                    setTimeout(function() {  panel.classList.add('slide-lower-left');}, (fortuneTeller.colorLength * 1000));
            ...
            case 'lower-right':
                    ...
                    setTimeout(function() {  panel.classList.add('slide-lower-right');}, (fortuneTeller.colorLength * 1000));
