...
fadeLoop(i){ 
    ...
    rotateLoop(i){ 
        ...
        console.log('inside: ' +  i);
        console.log('rotate time = ' + (i * 2000));
        switch (panel.id) {
            case 'upper-left':
                    setTimeout(function() {  panel.classList.add('rotate-upper-left');}, (i * 2000));
                    setTimeout(function() {  panel.classList.remove('rotate-upper-left');}, 1000 + ((i * 2000)));

                    break;
            case 'upper-right':
                    setTimeout(function() {  panel.classList.add('rotate-upper-right');}, (i * 2000));
                    setTimeout(function() {  panel.classList.remove('rotate-upper-right');}, 1000 + ((i * 2000)));

                    break;
            case 'lower-left':
                    setTimeout(function() {  panel.classList.add('rotate-lower-right');}, (i * 2000));
                    setTimeout(function() {  panel.classList.remove('rotate-lower-right');}, 1000 + ((i * 2000)));

                    break;
            case 'lower-right':
                    setTimeout(function() {  panel.classList.add('rotate-lower-left');}, (i * 2000));
                    setTimeout(function() {  panel.classList.remove('rotate-lower-left');}, 1000 + ((i * 2000)));
